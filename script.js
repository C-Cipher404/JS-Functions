...
const newPassport = function (person) {
  person.passport = Math.trunc(Math.randon() * 1000000000000);
};
...
// Call Method
book.call(errowings, 23, 'Sarah Wiliams');
...
(function () {
  ...
  ////MINE////////
  // const header2.addEventListener('click') = document.querySelector.header.style.color ='blue';
